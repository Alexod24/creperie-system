-- Función definitiva para procesar preparación con registro de producto terminado
...
BEGIN
  ...
  -- Obtener nombre del producto para el log (opcional, pero útil para depurar)
  ...
  -- 2. Registrar la ENTRADA del producto preparado (Suma al inventario si tuviera stock, o al menos deja rastro)
  -- Nota: Aquí podrías actualizar un campo 'current_stock' en products si lo tuvieras, 
  -- por ahora registramos el movimiento para que aparezca en el historial.
  ...
  -- 3. Restar stock de los insumos y registrar movimientos de salida
  FOR recipe_item IN 
